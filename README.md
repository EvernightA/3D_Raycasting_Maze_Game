...
## Requirements
> **Warning (performance):** This game may use a lot of CPU/GPU resources due to an unoptimized real-time raycasting/render loop.  
> I’m working on optimizations and settings to reduce resource usage.

- Linux operating system
- GCC compiler
- X11 development libraries (`libx11-dev`, `libxext-dev`)
- MiniLibX library (already included in the project)
...
2. **Color definitions** (required):
   ...
   ```
   > No space between values, only commas
...
- **Convert images to XPM (textures):**
- https://convertio.co/png-xpm/
- https://convertio.co/jpg-xpm/
