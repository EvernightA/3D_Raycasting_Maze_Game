...
/*   Updated: 2025/12/08 11:27:58 by fsamy-an         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	img_initialization(t_display *display)
{
	...
	display->texture.wall_img = mlx_xpm_file_to_image(display->mlx2.mlx_ptr,"./textures/f.xpm", &x, &y);
	display->texture.floor_img = mlx_xpm_file_to_image(display->mlx2.mlx_ptr,"./textures/w.xpm", &x, &y);
